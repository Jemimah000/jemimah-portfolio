...
const floatingItems = [
  {
    content: "✦",
    className:
      "left-[26%] top-[10%] text-[#ffd95e] text-xl",
    duration: 4,
    delay: 0,
  },
  {
    content: "✧",
    className:
      "left-[46%] top-[24%] text-[#b896ff] text-2xl",
    duration: 5,
    delay: 1,
  },
  {
    content: "♡",
    className:
      "right-[10%] top-[36%] text-[#ff8fa3] text-3xl",
    duration: 4.5,
    delay: 0.5,
  },
  {
    content: "✦",
    className:
      "right-[28%] top-[16%] text-[#ffd95e] text-lg",
    duration: 3.5,
    delay: 1,
  },
  {
    content: "✧",
    className:
      "left-[35%] top-[58%] text-[#a98cff] text-2xl",
    duration: 5,
    delay: 0,
  },
  {
    content: "✦",
    className:
      "right-[18%] top-[72%] text-[#ffd95e] text-2xl",
    duration: 4,
    delay: 1.5,
  },
  {
    content: "♡",
    className:
      "left-[30%] bottom-[18%] text-[#ff9eb5] text-2xl",
    duration: 4.5,
    delay: 0.8,
  },
];
